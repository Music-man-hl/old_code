...
class OrderModel
{
   ...
   //获取房型
   static function getProduct($channel,$shop_id,$voucher_id)
   {
   ...
   static function getOrderByVoucher($voucherId)
   {
   ...
   static function getShop($id)
   {
    ...
    //获取层级
    static function getStandard($level1,$level2)
    {
  ...
  static function getOrderVoucherByOrder($order_id)
  {
  ...
  static function productVoucherExist($order_id){
    ...
    static function getVoucherByOrderId($order_id,$voucher_id,$user)
    {
    ...
    // 格式化套餐名称
    static function formatItemName($item)
    {
        $names = [];
        for($i = 1; $i <= 3; $i++){
