...
class OrderModel
{
    ...
    function getOrders($channels,$users,$limit,$status)
    {
        ...
        $field  = 'o.`order`,o.`create`,o.`sub_status`,o.`status`,o.`total`,o.`count`,o.`product`,o.`product_name`,o.`expire`,o.`type`,i.data,o.`refund_status`,o.`product`,o.`status`,o.`refund`,o.`rebate`,o.`sales_rebate`,o.`shop_id`';
    ...
    function getOrderById($channels,$users,$order)
    {
        ...
        $field  = 'o.`id`,o.`type`,o.`channel`,o.`order`,o.`create`,o.`status`,o.`total`,o.`refund`,o.`rebate`,o.`sales_rebate`,o.`count`,o.`product`,o.`expire`,i.data,o.`product`,o.`contact`,o.`mobile`,e.`remark`,o.`refund_status`,o.`refund_status`,o.`shop_id`,o.`type`,o.`product_name`';
