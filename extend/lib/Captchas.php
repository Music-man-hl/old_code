...
//        'codeSet'  => '2345678abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY',
        'codeSet'  => 'abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY', //只要字母
        // 验证码字符集合
        'expire'   => 1800,
        // 验证码过期时间（s）
        'useZh'    => false,
    ...
    public function entry($id = '')
    {
        ...
        // 验证码使用随机字体
        $ttfPath = __DIR__ . '/../../data/assets/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/';
        ...
        redis::set($key,$secode,$this->expire);
    ...
    private function authcode($str)
    {
        ...
        return redis_prefix(). 'captcha_'.md5($key . $str);
    }
}
